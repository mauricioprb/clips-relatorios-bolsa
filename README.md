...
Sistema web para controle e geração automática de relatórios mensais de bolsista. Permite cadastrar dados do bolsista, grade semanal, atividades padrão, registrar atividades diárias, preencher dias vazios automaticamente e gerar o PDF do relatório.

## Variáveis de ambiente
Crie um arquivo `.env` a partir de `.env.example`:

- `DATABASE_URL` – string de conexão PostgreSQL.  
  - Em Docker: `postgresql://ciclaro:senha-segura@db:5432/ciclaro?schema=public`
