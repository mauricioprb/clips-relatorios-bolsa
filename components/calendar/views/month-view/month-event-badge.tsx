...
const eventBadgeVariants = cva(
  "mx-1 flex size-auto h-6.5 select-none items-center justify-between gap-1.5 truncate whitespace-nowrap rounded-md border px-2 text-xs",
  {
    variants: {
      color: {
        // Colored variants
        azul: "border-blue-200 bg-blue-50 text-blue-700 dark:border-blue-800 dark:bg-blue-950/50 dark:text-blue-300",
        verde:
        ...
        roxo: "border-purple-200 bg-purple-50 text-purple-700 dark:border-purple-800 dark:bg-purple-950/50 dark:text-purple-300",
        laranja:
        ...
        // Dot variants
        "azul-dot": "bg-secondary text-foreground [&_svg]:fill-blue-600",
        "verde-dot": "bg-secondary text-foreground [&_svg]:fill-green-600",
        "vermelho-dot": "bg-secondary text-foreground [&_svg]:fill-red-600",
        "laranja-dot": "bg-secondary text-foreground [&_svg]:fill-orange-600",
        "roxo-dot": "bg-secondary text-foreground [&_svg]:fill-purple-600",
        "amarelo-dot": "bg-secondary text-foreground [&_svg]:fill-yellow-600",
        "cinza-dot": "bg-secondary text-foreground [&_svg]:fill-gray-600",
      },
      multiDayPosition: {
